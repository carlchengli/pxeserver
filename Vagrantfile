...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "file", source: "pip.conf", destination: "/tmp/pip.conf"
  config.vm.provision "shell",
    inline: "sudo mv /tmp/sources.list /etc/apt/sources.list; sudo mv /tmp/pip.conf /etc/pip.conf; sudo apt-get update"
